...
[source, shell, role="copypaste"]
----
oc create -n {{ USER_ID}}-bookinfo -f $PROJECT_SOURCE/cloud-native-workshop-v2m3-labs/istio/virtual-service-all-v1.yaml
----
...
[source, shell, role="copypaste"]
----
oc apply -n {{ USER_ID}}-bookinfo -f $PROJECT_SOURCE/cloud-native-workshop-v2m3-labs/istio/virtual-service-reviews-jason-v2-v3.yaml
----
