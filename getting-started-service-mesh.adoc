...
To get started, {{ ECLIPSE_CHE_URL }}[access the CodeReady Workspaces instance^] and log in using the username and password you’ve been assigned (e.g. `{{ USER_ID }}/{{ DS_USER_PASSWORD }}`):
...
----
cd $PROJECT_SOURCE/cloud-native-workshop-v2m3-labs && git checkout ocp-4.9
----
