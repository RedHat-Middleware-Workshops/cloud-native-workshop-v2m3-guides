...
based on *Keycloak*
* Other open source projects like https://gogs.io/[Gogs^] (Git server that holds application source code), https://knative.dev[Knative^] (for serverless apps), https://jenkins.io/[Jenkins^] and https://cloud.google.com/tekton/[Tekton^] (CI/CD pipelines), https://prometheus.io[Prometheus^] and https://grafana.com[Grafana^] (monitoring apps), and more.
