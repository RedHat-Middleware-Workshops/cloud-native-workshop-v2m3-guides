...
----
oc apply -n {{ USER_ID}}-bookinfo -f $PROJECT_SOURCE/cloud-native-workshop-v2m3-labs/istio/bookinfo.yaml
----
...
[source,shell, role="copypaste"]
----
oc apply -n {{ USER_ID}}-bookinfo -f $PROJECT_SOURCE/cloud-native-workshop-v2m3-labs/istio/bookinfo-gateway.yaml
----
...
[source,shell, role="copypaste"]
----
oc apply -n {{ USER_ID}}-bookinfo -f $PROJECT_SOURCE/cloud-native-workshop-v2m3-labs/istio/destination-rule-all.yaml
----
